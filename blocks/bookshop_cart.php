...
function b_bookshop_cart_show($options)
{
    ...
    $block['block_vatAmount']            = sprintf('%0.' . $dec . 'f', $vatAmount);                // VAT amount
    $block['block_commandAmountTTC']     = sprintf('%0.' . $dec . 'f', $commandAmountTTC);    // Tax amount of the order
    $block['block_discountsDescription'] = $discountsDescription;                    // List of discounts given
