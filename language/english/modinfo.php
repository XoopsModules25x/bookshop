...
//Help
define('_MI_BOOKSHOP_DIRNAME', basename(dirname(dirname(__DIR__))));
define('_MI_BOOKSHOP_HELP_HEADER', __DIR__.'/help/helpheader.html');
define('_MI_BOOKSHOP_BACK_2_ADMIN','Back to Administration of ');
define('_MI_BOOKSHOP_HELP_OVERVIEW','Overview');

//define('_MI_BOOKSHOP_HELP_DIR', __DIR__);

//help multi-page
define('_MI_BOOKSHOP_HELP1','YYYYY');
define('_MI_BOOKSHOP_HELP2','YYYYY');
define('_MI_BOOKSHOP_HELP3','YYYYY');
define('_MI_BOOKSHOP_HELP4','YYYYY');
define('_MI_BOOKSHOP_HELP5','YYYYY');
define('_MI_BOOKSHOP_HELP6','YYYYY');
