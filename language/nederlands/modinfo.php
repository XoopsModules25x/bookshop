...
define('_MI_BOOKSHOP_BNAME3', 'Categorie�n');
...
define('_MI_BOOKSHOP_SMNAME3', 'Categorie�n');
define('_MI_BOOKSHOP_SMNAME4', 'Categorie�n map');
...
define('_MI_BOOKSHOP_ADMENU2', 'Categorie�n');
...
define('_MI_BOOKSHOP_SUMMARY1_SHOW', 'Laat recente boeken zien in alle categorie�n?');
...
define('_MI_BOOKSHOP_OPT241', 'Cr�eer ze in de volgorde zoals ze in de tekst staan');
