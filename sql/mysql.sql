...
CREATE TABLE `bookshop_books` (
  ...
  `book_number` varchar(60) NOT NULL COMMENT 'Book number, for example for periodicals',
  ...
  `book_submitted` int(10) unsigned NOT NULL default '0' COMMENT 'date which the book has been submitted on the website',
  `book_hits` int(11) unsigned NOT NULL default '0' COMMENT 'Number of times a book details were viewed',
  ...
  `book_stock` mediumint(8) unsigned NOT NULL COMMENT 'Book quantity in stock',
  `book_alert_stock` mediumint(8) unsigned NOT NULL COMMENT 'Number from which we must issue an alert',
...
CREATE TABLE `bookshop_cat` (
  ...
  `cat_advertisement` text NOT NULL COMMENT 'Advertising category',
...
CREATE TABLE `bookshop_commands` (
  ...
  `cmd_bill` tinyint(1) unsigned NOT NULL default '0' COMMENT 'Customer demand a paper bill?',
  `cmd_password` varchar(32) NOT NULL COMMENT 'Used to print bills online',
...
CREATE TABLE `bookshop_related` (
  ...
  `related_book_id` int(10) unsigned NOT NULL COMMENT 'Id du livre ma�tre',
  `related_book_related` int(10) unsigned NOT NULL COMMENT 'Id du livre � afficher avec le ma�tre',
