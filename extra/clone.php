...
cloneFileFolder('modules/bookshop');

echo "Happy cloning...\n";
echo 'check directory modules/' . $patterns['bookshop'] . " for cloned module \n";
echo "Consider modifying new module by editing language/english/modinfo.php and assets/images/bookshop_logo.png manually (if you care)\n";
