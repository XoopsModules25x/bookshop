...
if(!empty($_POST['btnsubmit'])) {			// The form was submited
	...
	if($canRate) {
		...
		$book_vote_data->setVar('vote_rating', intval($_POST['rating']));
		...
		// Calcul du nombre de votes et du total des votes pour mettre à jour les informations du livre
		$totalVotes = 0;
		$sumRating = 0;
		$ret = 0;
	...
	$xoopsOption['template_main'] = 'bookshop_rate_book.html';
