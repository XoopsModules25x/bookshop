...
<{if $block.showMore }>
    <br>
    <div align='center'><a href="<{$smarty.const.BOOKSHOP_URL}>recommended.php" title="<{$smarty.const._BOOKSHOP_SEEMORE_RECOMM}>"><{$smarty.const._BOOKSHOP_SEEMORE_RECOMM}></a></div>
<{/if}>
