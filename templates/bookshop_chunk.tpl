...
<div class="featured-blocks-titles"><h2><img src="<{$smarty.const.BOOKSHOP_IMAGES_URL}>icon-book-person.png" alt="" border="0"/><{$title}></h2></div>
                    ...
                    <tr>
                        <td class="page-curl_01">
                            ...
                            <div class="bookshop_bookprice"><br><{if $book.book_stock > 0 }><{$smarty.const._BOOKSHOP_PRICE}> <a href="<{$smarty.const.BOOKSHOP_URL}>caddy.php?op=addbook&book_id=<{$book.book_id}>"
                                    ...
                                    <{$book.book_discount_price_ttc}><{else}><{$book.book_price_ttc}><{/if}> <{$mod_pref.money_full}> <img src="<{$smarty.const.BOOKSHOP_IMAGES_URL}>cartadd.png" alt="" border="0"/></a><{else}><{$mod_pref.nostock_msg}><{/if}></div>
                        </td>
                    </tr>
                </table>
            </td>
