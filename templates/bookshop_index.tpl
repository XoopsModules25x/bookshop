            ...
            <td class="category-list">
                ...
                <table border='0' cellspacing='5' cellpadding='0' align='center' class="bookshop_categorylist">
                    <tr>
                        ...
                        <td valign="top">
                            <a href="<{$category.cat_url_rewrited}>" title="<{$category.cat_href_title}>"><{if $category.cat_imgurl != ''}><img src="<{$xoops_url}>/uploads/<{$category.cat_imgurl}>" border="0" alt="" /><{else}><img src="<{$smarty.const.BOOKSHOP_IMAGES_URL}>icon-cat.png"
                                                                                                                                                                                                                                       alt="" /><{/if}>
...
<{* **************************************** RECENT BOOKS ******************************************** *}>
<{if count($books) > 0 }>
    <div class="featured-blocks-titles"><h2><img src="<{$smarty.const.BOOKSHOP_IMAGES_URL}>icon-book-person.png" alt="<{$smarty.const._BOOKSHOP_CART}>" border="0"/><{$smarty.const._BOOKSHOP_MOST_RECENT}></h2></div>
